...
> = {
  ...
  sauce: { seoTitle: "Sauce and Condiment Manufacturers", h1: "Find sauce and condiment manufacturers", description: "Compare manufacturers whose public descriptions name sauces or condiments. Confirm formula, process, packaging, and storage fit with a co-packer.", questions: ["Is this formula shelf-stable or refrigerated?", "Can the filler handle the product viscosity and package?"] },
  salsa: { seoTitle: "Salsa Manufacturers", h1: "Find salsa manufacturers", description: "Compare manufacturers that publicly name salsa. Ask a co-packer about acidified process fit, fresh versus shelf-stable storage, and particulate size.", questions: ["Do you run fresh refrigerated or shelf-stable salsa?", "What particulate size can the filler handle?"] },
  "dressings-marinades": { seoTitle: "Dressing and Marinade Manufacturers", h1: "Find dressing and marinade manufacturers", description: "Compare manufacturers that publicly name dressings, vinaigrettes, or marinades. Confirm emulsion, allergen, process, and pack fit with a co-packer.", questions: ["Does the line run emulsions or only thinner liquids?", "What allergen controls apply to this formula?"] },
  "dips-hummus": { seoTitle: "Dips and Hummus Manufacturers", h1: "Find dips and hummus manufacturers", description: "Compare manufacturers that publicly name dips or hummus. Refrigerated capacity, allergens, packaging, and cold chain drive fit; confirm the process with a co-packer.", questions: ["Is this refrigerated capacity?", "Do you use HPP for this product, or another process?"] },
