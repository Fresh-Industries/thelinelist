...
export const introInputSchema = z
  .object({
    ...
    consent: z.literal("yes", { error: "Confirm that The Line List may store this request and follow up by email." }),
...
export const claimInputSchema = z
  .object({
    ...
    consent: z.literal("yes", { error: "Confirm that The Line List may store this submission and follow up by email." }),
    startedAt: z.string().trim().min(1),
    hp: optionalText(120),
    utm_source: optionalText(200),
    utm_medium: optionalText(200),
