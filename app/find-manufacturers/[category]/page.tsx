  ...
  return (
    <>
      ...
      <main id="main"><div className="wrap product-hub category-page">
        ...
        <div className="category-results-heading"><p className="kicker">Manufacturer results</p><h2>{plants.length > 0 ? `${plants.length} manufacturers that publicly mention ${entry.label.toLowerCase()}` : `No manufacturers publicly mention ${entry.label.toLowerCase()} yet`}</h2></div>
