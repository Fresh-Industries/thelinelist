...
import { CATEGORY_HUB_CONTENT, PRODUCT_CATEGORIES, categoryFaqs, categorySnapshot, filterPlants, getProductCategory } from "@/lib/directory";
  ...
  return (
    <>
      ...
      <main id="main"><div className="wrap product-hub category-page">
        ...
        <div className="category-results-heading"><p className="kicker">Manufacturer results</p><h2 id="manufacturer-results-heading" tabIndex={-1}>{plants.length > 0 ? `${plants.length} manufacturers that publicly mention ${entry.label.toLowerCase()}` : `No manufacturers publicly mention ${entry.label.toLowerCase()} yet`}</h2></div>
