...
export default function PrivacyPage() {
  return (
    <><SiteHeader /><main id="main"><article className="prose wrap legal-page">
      ...
      <h2>Where form data goes</h2><p>Product workspaces, account records, and contact-help or listing submissions are stored in PostgreSQL when the production service is configured. Uploaded product artwork may be stored privately in Vercel Blob. Operational notifications may also be sent to our review inbox. Newsletter emails are sent to the configured newsletter provider, currently Beehiiv or Kit when enabled.</p>
