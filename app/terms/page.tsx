...
export default function TermsPage() {
  return (
    <><SiteHeader /><main id="main"><article className="prose wrap legal-page">
      ...
      <h2>Manufacturer contact help</h2><p>A contact-help request asks The Line List to review the inquiry and follow up by email. It is not an agreement, accepted order, direct relationship, manufacturer response, or promise of a match. Manufacturers make their own decisions about projects and terms.</p>
