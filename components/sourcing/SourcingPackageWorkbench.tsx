        ...
        <div className="packaging-layout">
          <aside className="tool-controls">
            ...
            <div className="workbench-sliders">
              <label>Logo size <input type="range" min={config.logo.scale.min} max={config.logo.scale.max} step={config.logo.scale.step} value={logo.scale} onChange={(event) => setLogo("scale", Number(event.target.value))} /></label>
              <label>Left / right <input type="range" min={config.logo.horizontal.min} max={config.logo.horizontal.max} step={config.logo.horizontal.step} value={logo.x} onChange={(event) => setLogo("x", Number(event.target.value))} /></label>
              <label>Up / down <input type="range" min={config.logo.vertical.min} max={config.logo.vertical.max} step={config.logo.vertical.step} value={logo.y} onChange={(event) => setLogo("y", Number(event.target.value))} /></label>
            </div>
